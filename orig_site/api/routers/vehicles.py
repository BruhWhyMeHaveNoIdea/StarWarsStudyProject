...
def read_vehicle(vehicle_id: int, db: Session = Depends(get_db)):
    ...
    vehicle_dict = {c.key: getattr(db_vehicle, c.key) for c in db_vehicle.__table__.columns}
    vehicle_dict["pilot_ids"] = [character.id for character in db_vehicle.pilots]
